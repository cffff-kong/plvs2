    ...
    bWaitForCameraInfo_(bWaitForCameraInfo)
{
    ...
    {
        info_color_sub = this->create_subscription<sensor_msgs::msg::CameraInfo>("/camera/color/camera_info", 10, std::bind(&RgbdSlamNode::GrabCameraInfo, this, std::placeholders::_1));
